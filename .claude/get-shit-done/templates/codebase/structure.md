...
- Usage: Reference from command with `@D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
