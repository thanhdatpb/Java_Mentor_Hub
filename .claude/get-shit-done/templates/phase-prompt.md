...
<!-- For checkpoint task examples and patterns, see @D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/references/checkpoints.md -->
...
See `D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
