...
<required_reading>
@D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/references/domain-probes.md
@D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/references/gate-prompts.md
@D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/workflows/discuss-phase-power.md
