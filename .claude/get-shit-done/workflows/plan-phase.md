...
@D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/references/ui-brand.md
@D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/references/revision-loop.md
...
**If found:**
1. Read template: `D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/references/tdd.md to all eligible tasks:
