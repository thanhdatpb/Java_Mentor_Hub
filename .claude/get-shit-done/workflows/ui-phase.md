...
```markdown
Read D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/agents/gsd-ui-checker.md for instructions.
