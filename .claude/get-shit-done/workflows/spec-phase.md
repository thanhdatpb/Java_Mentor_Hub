...
```bash
INIT=$(node "D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/Workspace/Java/Projects/Java_Mentor_Hub/.claude/get-shit-done/templates/spec.md.
