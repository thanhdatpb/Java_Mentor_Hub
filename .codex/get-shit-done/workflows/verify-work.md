...
<template>
@D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/templates/UAT.md
</template>
...
Read and follow `D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/workflows/transition.md`.
...
```bash
node "D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/workflows/diagnose-issues.md
