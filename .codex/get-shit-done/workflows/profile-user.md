...
Key references:
- @D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/USER-PROFILE.md" "D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/AGENTS.md
```
