...
```
Task(
  prompt="Read D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/templates/SECURITY.md`
