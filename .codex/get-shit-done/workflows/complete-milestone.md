...
```bash
node "D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/get-shit-done/templates/retrospective.md`.
