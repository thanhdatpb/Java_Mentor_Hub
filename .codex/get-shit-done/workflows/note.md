...
- **Global scope**: `D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/notes/`)
...
2. Glob `D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/notes/*.md` (if directory exists) — global notes
...
Global (D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Workspace/Java/Projects/Java_Mentor_Hub/.codex/notes/` — works in any directory
